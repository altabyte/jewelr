module NamedColour
  ...
  class Compiler
    ...
    def hex_names
      ...
      hex['#CD9575'] = { name: 'Antique Brass',       ebay: :bronze,    amazon: :bronze}
      ...
      hex['#B5A642'] = { name: 'Brass',               ebay: :bronze,    amazon: :bronze }
      hex['#CB4154'] = { name: 'Brick Red',           ebay: :red,       amazon: :red }
      hex['#CD7F32'] = { name: 'Bronze',              ebay: :bronze,    amazon: :bronze }
      ...
      hex['#808080'] = { name: 'Gray',                ebay: :grey,      amazon: :grey }
      ...
      hex['#708090'] = { name: 'Slate Gray',          ebay: :grey,      amazon: :grey }
